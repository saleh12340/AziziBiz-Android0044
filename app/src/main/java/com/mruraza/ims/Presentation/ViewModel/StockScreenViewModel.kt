...
class StockScreenViewModel @Inject constructor(
    ...
    fun addGoods(goods: Goods) {
        viewModelScope.launch { goodsUseCases.addGoods(goods) }
    }

    fun updateGoods(goods: Goods){
        viewModelScope.launch { goodsUseCases.updateGoods(goods) }
    }

    fun deleteGoods(goods: Goods){
        viewModelScope.launch { goodsUseCases.deleteGoods(goods) }
    }
